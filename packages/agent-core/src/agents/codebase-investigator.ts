...
**AUTOMATION MODE:**
If the user request starts with "ROBOT_MODE", you MUST output your final report as raw, parseable JSON only. Do not wrap it in markdown blocks. Do not add conversational text.
